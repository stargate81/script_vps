...
link1_status=$(curl -Is  | grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is https://www.itechtics.com/?dl_id=133 | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots https://www.itechtics.com/?dl_id=133 # Windows Server 2012 R2 
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://www.itechtics.com/?dl_id=133 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://www.itechtics.com/?dl_id=133
else
...
sudo wget -P /floppy https://us.softpedia-secure-download.com/dl/4002649ab381ae14a591c3352c187b38/5ffc73ef/300676029/drivers/network/Ethernet%20CD/23.5/PROWinx64.exe # Intel Network Adapter for Windows Server 2012 R2 
